...
class Ball extends GameBlock {
  ...
  paddleCollision(paddle) {
    ...
    if (
      ...
      // Define those anonymous numbers as variables
      // Potentially reduce redundancy by passing in the values below as parameters
      if (ballX < paddle.middlePoint() - 20) {
        this.velocityX = -5;
      } else if (ballX < paddle.middlePoint() - 15) {
        this.velocityX = -4;
      } else if (ballX < paddle.middlePoint() - 7.5) {
        this.velocityX = -3;
  ...
  // More opportunity for drying up the code
  leftEdge() {
