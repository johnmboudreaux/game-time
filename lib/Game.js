...
class Game {
  constructor(context, canvas) {
    ...
    // No anonymous numbers - adds lines but variables make refactoring easier
  ...
  loadScreen() {
    ...
    this.context.fillText('BRICK CITY', 150, 180);
    this.context.font = '30px Arial';
    this.context.fillText('click start', 310, 300);
    this.context.fillStyle = 'gray';
    this.context.font = '20px Arial';
    this.context.fillText('Use your mouse, to control your paddle, guide the ball,', 130, 380);
    this.context.fillText('and destroy the bricks.', 270, 430);
